# Generated by Django 2.2.5 on 2020-12-14 02:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('hbook', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='heros', to='bookset.BookInfo', verbose_name='所属图书')),
            ],
            options={
                'verbose_name': '英雄',
                'db_table': 'tb_heros',
